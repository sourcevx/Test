...
use Fp\RubricaBundle\Model\Location;
use Fp\RubricaBundle\Form\Type\LocationType;
use Fp\RubricaBundle\Entity\City;
...
class LocationController extends Controller
{
    ...
    public function dependentSelectsAction()
    {
        ...
        $cities = $em->getRepository("RubricaBundle:City")->findAll();
     ...
     * @Template("RubricaBundle:Location:new_location.html.twig")
     */
     ...
     * @ParamConverter("city", class="RubricaBundle:City")
     * @Template("RubricaBundle:Location:edit_location.html.twig")
     */
