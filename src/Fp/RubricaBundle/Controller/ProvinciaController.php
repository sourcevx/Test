...
use Fp\RubricaBundle\Entity\Provincia;
use Fp\RubricaBundle\Form\ProvinciaType;
...
class ProvinciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RubricaBundle:Provincia')->findAll();
     ...
     * @Method("POST")
     * @Template("RubricaBundle:Provincia:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RubricaBundle:Provincia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RubricaBundle:Provincia:edit.html.twig")
     */
