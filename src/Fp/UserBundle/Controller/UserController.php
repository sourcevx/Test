...
class UserController extends Controller
{
   // use \DocDigital\Bundle\ToolsBundle\Controller\BasicControllerTasksTrait;
    ...
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('FpUserBundle:User')->createQueryBuilder('e');
     ...
     * @Method("POST")
     * @Template("FpUserBundle:User:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FpUserBundle:User:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();

        $repo = $em->getRepository('FpUserBundle:User');
        $entity = $repo->find($id);
