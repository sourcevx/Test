...
use Fp\UserBundle\Entity\Role;
use Fp\UserBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('FpUserBundle:Role')->createQueryBuilder('e');
     ...
     * @Method("POST")
     * @Template("FpUserBundle:Role:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FpUserBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FpUserBundle:Role:edit.html.twig")
     */
